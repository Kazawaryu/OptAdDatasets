...
| The visualization of the performance of classic 3D perception models in autonomous driving, which are retrained on the original dataset $\mathcal{D}_{\mathcal{S}_0}$ and optimized dataset $\mathcal{D}_{\mathcal{S}_3}$.
